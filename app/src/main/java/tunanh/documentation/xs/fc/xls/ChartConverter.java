...
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFCell;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFChart;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFChart.HSSFChartType;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFChart.HSSFSeries;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFDataFormat;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFFormulaEvaluator;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFName;
...
import tunanh.documentation.xs.ss.model.XLSModel.ARow;
import tunanh.documentation.xs.ss.model.XLSModel.ASheet;
...
import tunanh.documentation.xs.ss.model.style.CellStyle;
import tunanh.documentation.xs.ss.util.format.NumericFormatter;
import tunanh.documentation.xs.thirdpart.achartengine.ChartFactory;
import tunanh.documentation.xs.thirdpart.achartengine.chart.AbstractChart;
import tunanh.documentation.xs.thirdpart.achartengine.chart.ColumnBarChart.Type;
import tunanh.documentation.xs.thirdpart.achartengine.chart.PointStyle;
import tunanh.documentation.xs.thirdpart.achartengine.model.CategorySeries;
import tunanh.documentation.xs.thirdpart.achartengine.model.XYMultipleSeriesDataset;
import tunanh.documentation.xs.thirdpart.achartengine.model.XYSeries;
import tunanh.documentation.xs.thirdpart.achartengine.renderers.DefaultRenderer;
import tunanh.documentation.xs.thirdpart.achartengine.renderers.SimpleSeriesRenderer;
import tunanh.documentation.xs.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer;
import tunanh.documentation.xs.thirdpart.achartengine.renderers.XYSeriesRenderer;
import tunanh.documentation.xs.thirdpart.achartengine.util.MathHelper;
...
public class ChartConverter
{
    ...
    private List<Double> getData(ASheet sheet, Ptg[] valuePtg )
    {
    	...
    	if(valuePtg[0] instanceof Area3DPtg area3DPtg)
        {
        ...
        else if(valuePtg[0] instanceof MemFuncPtg)
        {
            ...
            {
                if(valuePtg[index] instanceof Ref3DPtg ref)
                {
                    //chart source data was not the current sheet
                    Sheet cursheet;
        ...
        else if(valuePtg[0] instanceof NameXPtg)
        {
            try
            {
                ...
                if(valueEval instanceof AreaEval area)
                {
        ...
        else if(valuePtg.length > 0 && valuePtg[0] instanceof Ref3DPtg ref)
        {
            Sheet cursheet;
            ExternalSheet externalSheet = workbook.getExternalSheet(ref.getExternSheetIndex());
            if(externalSheet == null)
...
//                else
        ...
        if(series.length > 0)
        {
            ...
            if(categoryLabelsPtg.length > 0 && categoryLabelsPtg[0] instanceof Area3DPtg area3DPtg)
            {
                Sheet cursheet;
    ...
    protected DefaultRenderer buildDefaultRenderer(Sheet sheet, HSSFChart chart)
    {
      ...
      {                 
          ...
          if(valuePtg.length > 0 && valuePtg[0] instanceof Area3DPtg area3DPtg)
          {
    ...
    protected CategorySeries buildCategoryDataset(Sheet sheet, HSSFChart chart) 
    {
        ...
        {  
            ...
            if(dataValuesPtg.length <= 0 || !(dataValuesPtg[0] instanceof Area3DPtg valuePtg))
            {
                return null;
            }
            ...
            if(categoryLabelsPtg.length > 0 && categoryLabelsPtg[0] instanceof Area3DPtg catPtg)
            {
