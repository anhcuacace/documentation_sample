...
import tunanh.documentation.xs.fc.hslf.record.ColorSchemeAtom;
import tunanh.documentation.xs.fc.hslf.record.Comment2000;
...
import tunanh.documentation.xs.fc.hslf.record.TextHeaderAtom;
...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(tunanh.documentation.xs.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new tunanh.documentation.xs.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see tunanh.documentation.xs.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public tunanh.documentation.xs.fc.hslf.record.Slide getSlideRecord()
    {
        return (tunanh.documentation.xs.fc.hslf.record.Slide)getSheetContainer();
    }
