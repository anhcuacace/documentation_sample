...
import tunanh.documentation.xs.fc.hssf.formula.function.Fixed2ArgFunction;
import tunanh.documentation.xs.fc.hssf.formula.function.Function;
import tunanh.documentation.xs.fc.ss.util.NumberComparer;
...
public abstract class RelationalOperationEval extends Fixed2ArgFunction {
	...
	private static int compareBlank(ValueEval v) {
		...
		if (v instanceof StringEval se) {
            return se.getStringValue().isEmpty() ? 0 : -1;
		}
