 ...
 *
 * @see tunanh.documentation.xs.fc.hssf.eventusermodel.HSSFEventFactory
 * @see tunanh.documentation.xs.fc.hssf.eventusermodel.HSSFListener
 * @see tunanh.documentation.xs.fc.hssf.eventusermodel.HSSFUserException
