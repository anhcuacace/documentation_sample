...
import tunanh.documentation.xs.common.borders.Border;
import tunanh.documentation.xs.common.borders.Borders;
import tunanh.documentation.xs.common.borders.Line;
import tunanh.documentation.xs.common.bulletnumber.ListData;
import tunanh.documentation.xs.common.bulletnumber.ListLevel;
...
import tunanh.documentation.xs.common.shape.WPAbstractShape;
import tunanh.documentation.xs.common.shape.WPAutoShape;
import tunanh.documentation.xs.common.shape.WPGroupShape;
import tunanh.documentation.xs.common.shape.WPPictureShape;
...
import tunanh.documentation.xs.fc.ddf.EscherTextboxRecord;
import tunanh.documentation.xs.fc.hwpf.HWPFDocument;
import tunanh.documentation.xs.fc.hwpf.model.FieldsDocumentPart;
import tunanh.documentation.xs.fc.hwpf.model.ListFormatOverride;
import tunanh.documentation.xs.fc.hwpf.model.ListTables;
import tunanh.documentation.xs.fc.hwpf.model.POIListData;
import tunanh.documentation.xs.fc.hwpf.model.POIListLevel;
import tunanh.documentation.xs.fc.hwpf.model.PicturesTable;
import tunanh.documentation.xs.fc.hwpf.usermodel.Bookmarks;
import tunanh.documentation.xs.fc.hwpf.usermodel.BorderCode;
import tunanh.documentation.xs.fc.hwpf.usermodel.CharacterRun;
import tunanh.documentation.xs.fc.hwpf.usermodel.Field;
import tunanh.documentation.xs.fc.hwpf.usermodel.HWPFAutoShape;
import tunanh.documentation.xs.fc.hwpf.usermodel.HWPFShape;
import tunanh.documentation.xs.fc.hwpf.usermodel.HWPFShapeGroup;
import tunanh.documentation.xs.fc.hwpf.usermodel.HeaderStories;
import tunanh.documentation.xs.fc.hwpf.usermodel.InlineWordArt;
import tunanh.documentation.xs.fc.hwpf.usermodel.LineSpacingDescriptor;
import tunanh.documentation.xs.fc.hwpf.usermodel.OfficeDrawing;
import tunanh.documentation.xs.fc.hwpf.usermodel.OfficeDrawings;
import tunanh.documentation.xs.fc.hwpf.usermodel.POIBookmark;
import tunanh.documentation.xs.fc.hwpf.usermodel.Paragraph;
import tunanh.documentation.xs.fc.hwpf.usermodel.PictureType;
import tunanh.documentation.xs.fc.hwpf.usermodel.Range;
import tunanh.documentation.xs.fc.hwpf.usermodel.Section;
import tunanh.documentation.xs.fc.hwpf.usermodel.Table;
import tunanh.documentation.xs.fc.hwpf.usermodel.TableCell;
import tunanh.documentation.xs.fc.hwpf.usermodel.TableRow;
import tunanh.documentation.xs.fc.util.LittleEndian;
import tunanh.documentation.xs.java.awt.Rectangle;
import tunanh.documentation.xs.java.util.Arrays;
...
import tunanh.documentation.xs.simpletext.view.PageAttr;
...
import tunanh.documentation.xs.wp.model.CellElement;
import tunanh.documentation.xs.wp.model.HFElement;
import tunanh.documentation.xs.wp.model.RowElement;
import tunanh.documentation.xs.wp.model.TableElement;
import tunanh.documentation.xs.wp.model.WPDocument;
...
public class DOCReader extends AbstractReader
{
    ...
    {
        poiDoc = new HWPFDocument(new FileInputStream(filePath));
    ...
    private void processParagraph(Paragraph para)
    {
        ...
        for (int i = 0; i < runCount && !abortReader; i++)
        {
            ...
            if (text.isEmpty() || run.isMarkedDeleted())
            {
                continue;
            }
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	tunanh.documentation.xs.java.awt.Color fillColor = shape.getForegroundColor();
            	tunanh.documentation.xs.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
                    ...
                    HWPFShape poiShape, Rectangle rect, float zoomX, float zoomY)
    {
        ...
        else if (poiShape instanceof HWPFShapeGroup poiGroup)
        {
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && !text.isEmpty())
		{
            ...
            // 字符颜色
            tunanh.documentation.xs.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            tunanh.documentation.xs.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
