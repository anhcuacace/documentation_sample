...
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFAnchor;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFComment;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFPolygon;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFShape;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFSimpleShape;
...
public abstract class AbstractShape
{
    ...
    public static AbstractShape createShape( HSSFShape hssfShape, int shapeId )
    {
        ...
        else if (hssfShape instanceof HSSFSimpleShape simpleShape)
        {
