...
import tunanh.documentation.xs.fc.hslf.record.AnimationInfo;
import tunanh.documentation.xs.fc.hslf.record.AnimationInfoAtom;
...
public final class MovieShape extends Picture
{
    ...
    * @param pictureIdx the index of the picture
    ...
    public String getPath()
    {
        ...
        {
            if (r[i] instanceof ExMCIMovie mci)
            {
