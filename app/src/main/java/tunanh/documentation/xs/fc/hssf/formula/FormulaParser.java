...
import tunanh.documentation.xs.constant.fc.ErrorConstant;
...
import tunanh.documentation.xs.fc.hssf.formula.ptg.ArrayPtg;
...
import tunanh.documentation.xs.fc.hssf.formula.ptg.FuncPtg;
...
import tunanh.documentation.xs.fc.hssf.formula.ptg.ParenthesisPtg;
...
import tunanh.documentation.xs.fc.hssf.formula.ptg.ValueOperatorPtg;
import tunanh.documentation.xs.fc.ss.SpreadsheetVersion;
import tunanh.documentation.xs.fc.ss.usermodel.ErrorConstants;
import tunanh.documentation.xs.fc.ss.util.AreaReference;
import tunanh.documentation.xs.fc.ss.util.CellReference;
import tunanh.documentation.xs.fc.ss.util.CellReference.NameType;
...
public final class FormulaParser {
	...
	private RuntimeException expected(String s) {
		...
		if (look == '=' && _formulaString.substring(0, _pointer - 1).trim().isEmpty()) {
