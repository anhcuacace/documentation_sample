...
import tunanh.documentation.xs.fc.hssf.record.CFHeaderRecord;
import tunanh.documentation.xs.fc.hssf.record.CalcCountRecord;
import tunanh.documentation.xs.fc.hssf.record.CalcModeRecord;
import tunanh.documentation.xs.fc.hssf.record.CellValueRecordInterface;
import tunanh.documentation.xs.fc.hssf.record.ColumnInfoRecord;
import tunanh.documentation.xs.fc.hssf.record.ContinueRecord;
import tunanh.documentation.xs.fc.hssf.record.DVALRecord;
import tunanh.documentation.xs.fc.hssf.record.DefaultColWidthRecord;
import tunanh.documentation.xs.fc.hssf.record.DefaultRowHeightRecord;
import tunanh.documentation.xs.fc.hssf.record.DeltaRecord;
import tunanh.documentation.xs.fc.hssf.record.DimensionsRecord;
import tunanh.documentation.xs.fc.hssf.record.DrawingRecord;
import tunanh.documentation.xs.fc.hssf.record.EOFRecord;
import tunanh.documentation.xs.fc.hssf.record.EscherAggregate;
import tunanh.documentation.xs.fc.hssf.record.FeatHdrRecord;
import tunanh.documentation.xs.fc.hssf.record.FeatRecord;
import tunanh.documentation.xs.fc.hssf.record.GridsetRecord;
import tunanh.documentation.xs.fc.hssf.record.GutsRecord;
import tunanh.documentation.xs.fc.hssf.record.IndexRecord;
import tunanh.documentation.xs.fc.hssf.record.IterationRecord;
import tunanh.documentation.xs.fc.hssf.record.MergeCellsRecord;
import tunanh.documentation.xs.fc.hssf.record.NoteRecord;
import tunanh.documentation.xs.fc.hssf.record.ObjRecord;
import tunanh.documentation.xs.fc.hssf.record.PaneRecord;
import tunanh.documentation.xs.fc.hssf.record.PrintGridlinesRecord;
import tunanh.documentation.xs.fc.hssf.record.PrintHeadersRecord;
import tunanh.documentation.xs.fc.hssf.record.Record;
import tunanh.documentation.xs.fc.hssf.record.RecordBase;
import tunanh.documentation.xs.fc.hssf.record.RefModeRecord;
import tunanh.documentation.xs.fc.hssf.record.RowRecord;
import tunanh.documentation.xs.fc.hssf.record.SCLRecord;
import tunanh.documentation.xs.fc.hssf.record.SaveRecalcRecord;
import tunanh.documentation.xs.fc.hssf.record.SelectionRecord;
import tunanh.documentation.xs.fc.hssf.record.TextObjectRecord;
import tunanh.documentation.xs.fc.hssf.record.UncalcedRecord;
import tunanh.documentation.xs.fc.hssf.record.WSBoolRecord;
import tunanh.documentation.xs.fc.hssf.record.WindowTwoRecord;
import tunanh.documentation.xs.fc.hssf.record.aggregates.ChartSubstreamRecordAggregate;
import tunanh.documentation.xs.fc.hssf.record.aggregates.ColumnInfoRecordsAggregate;
import tunanh.documentation.xs.fc.hssf.record.aggregates.ConditionalFormattingTable;
import tunanh.documentation.xs.fc.hssf.record.aggregates.CustomViewSettingsRecordAggregate;
import tunanh.documentation.xs.fc.hssf.record.aggregates.DataValidityTable;
import tunanh.documentation.xs.fc.hssf.record.aggregates.MergedCellsTable;
import tunanh.documentation.xs.fc.hssf.record.aggregates.PageSettingsBlock;
import tunanh.documentation.xs.fc.hssf.record.aggregates.RecordAggregate;
import tunanh.documentation.xs.fc.hssf.record.aggregates.RecordAggregate.PositionTrackingVisitor;
import tunanh.documentation.xs.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import tunanh.documentation.xs.fc.hssf.record.aggregates.RowRecordsAggregate;
import tunanh.documentation.xs.fc.hssf.record.aggregates.WorksheetProtectionBlock;
import tunanh.documentation.xs.fc.hssf.record.chart.ChartRecord;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFChart;
import tunanh.documentation.xs.fc.hssf.util.ColumnInfo;
import tunanh.documentation.xs.fc.hssf.util.HSSFPaneInformation;
import tunanh.documentation.xs.fc.ss.util.HSSFCellRangeAddress;
 ...
 *
 * @see tunanh.documentation.xs.fc.hssf.model.InternalWorkbook
 * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFSheet
 */
@ Internal
public final class InternalSheet
{
    ...
    public void visitContainedRecords(RecordVisitor rv, int offset)
    {
        ...
        for (int k = 0; k < _records.size(); k++)
        {
            ...
            if (record instanceof RecordAggregate agg)
            {
