...
package tunanh.documentation.xs.fc.hpsf;
...
import tunanh.documentation.xs.fc.poifs.filesystem.DirectoryEntry;
...
public abstract class SpecialPropertySet extends MutablePropertySet
{
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#clearSections()
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#setByteOrder(int)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#setFormat(int)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#setOSVersion(int)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#toInputStream()
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#write(DirectoryEntry, String)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.MutablePropertySet#write(OutputStream)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#equals(Object)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#getProperties()
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#getProperty(int)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#getPropertyBooleanValue(int)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#getPropertyIntValue(int)
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#hashCode()
     */
    public int hashCode()
    {
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#toString()
     */
    ...
    /**
     * @see   tunanh.documentation.xs.fc.hpsf.PropertySet#wasNull()
     */
