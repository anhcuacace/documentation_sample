...
import tunanh.documentation.xs.fc.ddf.EscherChildAnchorRecord;
...
import tunanh.documentation.xs.fc.ddf.EscherProperty;
import tunanh.documentation.xs.fc.ddf.EscherPropertyFactory;
                  ...
                  EscherContainerRecord spContainer, HSSFShape parent)
    {
        ...
        switch (type)
        {
            case ShapeTypes.TextBox:
                if (shapeToObj != null && !shapeToObj.isEmpty())
                {
