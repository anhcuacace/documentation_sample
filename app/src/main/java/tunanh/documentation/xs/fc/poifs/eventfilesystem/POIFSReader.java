...
package tunanh.documentation.xs.fc.poifs.eventfilesystem;
...
import tunanh.documentation.xs.fc.poifs.filesystem.DocumentInputStream;
import tunanh.documentation.xs.fc.poifs.filesystem.POIFSDocument;
import tunanh.documentation.xs.fc.poifs.filesystem.POIFSDocumentPath;
...
public class POIFSReader
{
    ...
    public void registerListener(final POIFSReaderListener listener,
                                 ...
                                 final String name)
    {
        if ((listener == null) || (name == null) || (name.isEmpty()))
        {
            throw new NullPointerException();
        }
        if (registryClosed)
