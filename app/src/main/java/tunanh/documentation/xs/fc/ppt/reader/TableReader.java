 ...
 * 时间:               上午9:20:42
 */
package tunanh.documentation.xs.fc.ppt.reader;
...
import tunanh.documentation.xs.pg.model.tableStyle.TableCellBorders;
import tunanh.documentation.xs.pg.model.tableStyle.TableCellStyle;
import tunanh.documentation.xs.pg.model.tableStyle.TableStyle;
    ...
    public void processCellSection(IControl control, PGMaster master, TextBox tb, Rectangle rect, Element tc, TableCellStyle  cellStyle)
    {
        ...
        {    
            ...
            if (tcPr != null)
            {
                ...
                {
                    switch (val) {
                        case "t" -> verAlign = WPAttrConstant.PAGE_V_TOP;
                        case "ctr" -> verAlign = WPAttrConstant.PAGE_V_CENTER;
                        case "b" -> verAlign = WPAttrConstant.PAGE_V_BOTTOM;
                        case "just" -> verAlign = WPAttrConstant.PAGE_V_CENTER;
                        case "dist" -> verAlign = WPAttrConstant.PAGE_V_CENTER;
                    }
