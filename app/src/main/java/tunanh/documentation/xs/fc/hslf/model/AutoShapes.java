...
import tunanh.documentation.xs.java.awt.geom.Arc2D;
import tunanh.documentation.xs.java.awt.geom.Ellipse2D;
import tunanh.documentation.xs.java.awt.geom.GeneralPath;
import tunanh.documentation.xs.java.awt.geom.Line2D;
import tunanh.documentation.xs.java.awt.geom.Rectangle2D;
import tunanh.documentation.xs.java.awt.geom.RoundRectangle2D;
...
{
    private static ShapeOutline[] shapes;
     ...
     *
    */
    public static tunanh.documentation.xs.java.awt.Shape transform(tunanh.documentation.xs.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public tunanh.documentation.xs.java.awt.Shape getOutline(Shape shape)
            {
        ...
        shapes[ShapeTypes.Can] = new ShapeOutline()
        {
            public tunanh.documentation.xs.java.awt.Shape getOutline(Shape shape)
            {
                ...
                path.moveTo(0, (float) adjval / 2);

                path.lineTo(0, 21600 - (float) adjval / 2);
                path.closePath();

                path.append(
                    new Arc2D.Float(0, 21600 - adjval, 21600, adjval, 180, 180, Arc2D.OPEN), false);
                path.moveTo(21600, 21600 - (float) adjval / 2);

                path.lineTo(21600, (float) adjval / 2);
