 ...
 * 时间:              上午9:59:09
 */
package tunanh.documentation.xs.fc.xls.Reader.drawing;
...
import tunanh.documentation.xs.ss.model.drawing.TextParagraph;
...
//      renderer.setMargins(new int[] {70, 60, 15, 55});
    ...
    protected CategorySeries buildCategoryDataset(Element chart, DefaultRenderer renderer) 
    {
        ...
        {  
            ...
            int color;
            if(!catList.isEmpty() && catList.size() == valList.size())
            {
