...
package tunanh.documentation.xs.fc.hslf;
...
import tunanh.documentation.xs.fc.fs.filesystem.CFBFileSystem;
import tunanh.documentation.xs.fc.fs.filesystem.Property;
import tunanh.documentation.xs.fc.hslf.blip.Metafile;
import tunanh.documentation.xs.fc.hslf.exceptions.CorruptPowerPointFileException;
import tunanh.documentation.xs.fc.hslf.exceptions.EncryptedPowerPointFileException;
import tunanh.documentation.xs.fc.hslf.model.Picture;
import tunanh.documentation.xs.fc.hslf.record.CurrentUserAtom;
import tunanh.documentation.xs.fc.hslf.record.ExOleObjStg;
import tunanh.documentation.xs.fc.hslf.record.PersistPtrHolder;
import tunanh.documentation.xs.fc.hslf.record.PersistRecord;
import tunanh.documentation.xs.fc.hslf.record.Record;
import tunanh.documentation.xs.fc.hslf.record.UserEditAtom;
import tunanh.documentation.xs.fc.hslf.usermodel.ObjectData;
...
//            rec[i] = Record.buildRecordAtOffset(docstream, offset.intValue());
            ...
            if (rec[i] instanceof PersistRecord psr)
            {
