...
import tunanh.documentation.xs.fc.hssf.record.aggregates.CFRecordsAggregate;
...
import tunanh.documentation.xs.fc.ss.usermodel.ConditionalFormatting;
import tunanh.documentation.xs.fc.ss.usermodel.ConditionalFormattingRule;
import tunanh.documentation.xs.fc.ss.usermodel.SheetConditionalFormatting;
import tunanh.documentation.xs.fc.ss.util.HSSFCellRangeAddress;
import tunanh.documentation.xs.fc.ss.util.Region;
...
public final class HSSFSheetConditionalFormatting implements SheetConditionalFormatting {
	 ...
	 *		 <tt>{@link tunanh.documentation.xs.fc.hssf.record.CFRuleRecord.ComparisonOperator}</tt>: <p>
	 * <ul>
	 *		 <li>BETWEEN</li>
	 *		 <li>NOT_BETWEEN</li>
	 *		 <li>EQUAL</li>
	 ...
	 * {@link tunanh.documentation.xs.fc.hssf.record.CFRuleRecord.ComparisonOperator#BETWEEN}) and
	 * {@link tunanh.documentation.xs.fc.hssf.record.CFRuleRecord.ComparisonOperator#NOT_BETWEEN} operations)
	 */
