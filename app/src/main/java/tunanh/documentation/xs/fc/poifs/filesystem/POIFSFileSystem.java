...
package tunanh.documentation.xs.fc.poifs.filesystem;
...
import tunanh.documentation.xs.fc.poifs.property.DirectoryProperty;
import tunanh.documentation.xs.fc.poifs.property.Property;
import tunanh.documentation.xs.fc.poifs.property.PropertyTable;
import tunanh.documentation.xs.fc.poifs.storage.BATBlock;
import tunanh.documentation.xs.fc.poifs.storage.BlockAllocationTableReader;
import tunanh.documentation.xs.fc.poifs.storage.BlockAllocationTableWriter;
import tunanh.documentation.xs.fc.poifs.storage.BlockList;
import tunanh.documentation.xs.fc.poifs.storage.BlockWritable;
import tunanh.documentation.xs.fc.poifs.storage.HeaderBlock;
import tunanh.documentation.xs.fc.poifs.storage.HeaderBlockConstants;
import tunanh.documentation.xs.fc.poifs.storage.HeaderBlockWriter;
import tunanh.documentation.xs.fc.poifs.storage.RawDataBlockList;
import tunanh.documentation.xs.fc.poifs.storage.SmallBlockTableReader;
import tunanh.documentation.xs.fc.poifs.storage.SmallBlockTableWriter;
import tunanh.documentation.xs.fc.util.CloseIgnoringInputStream;
...
public class POIFSFileSystem
{
    ...
    public static boolean hasPOIFSHeader(InputStream inp) throws IOException
    {
        ...
        if (inp instanceof PushbackInputStream pin)
        {
            pin.unread(header);
        }
        else
