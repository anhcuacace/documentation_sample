...
import tunanh.documentation.xs.fc.ddf.EscherBinaryTagRecord;
...
import tunanh.documentation.xs.fc.hslf.record.CString;
import tunanh.documentation.xs.fc.hslf.record.ColorSchemeAtom;
import tunanh.documentation.xs.fc.hslf.record.EscherTextboxWrapper;
import tunanh.documentation.xs.fc.hslf.record.ExtendedParagraphAtom;
import tunanh.documentation.xs.fc.hslf.record.OEPlaceholderAtom;
import tunanh.documentation.xs.fc.hslf.record.PPDrawing;
...
import tunanh.documentation.xs.fc.hslf.record.RoundTripHFPlaceholder12;
import tunanh.documentation.xs.fc.hslf.record.SheetContainer;
import tunanh.documentation.xs.fc.hslf.record.StyleTextPropAtom;
import tunanh.documentation.xs.fc.hslf.record.TextBytesAtom;
import tunanh.documentation.xs.fc.hslf.record.TextCharsAtom;
...
public abstract class Sheet
{
    ...
    protected static void findTextRuns(Record[] records, Vector found)
    {
        ...
        {
            if (records[i] instanceof TextHeaderAtom tha)
            {
                TextRun trun = null;
                ...
                if (records[i + 1] instanceof TextCharsAtom tca)
                {
                    trun = new TextRun(tha, tca, stpa);
                }
                else if (records[i + 1] instanceof TextBytesAtom tba)
                {
    ...
    public TextShape getPlaceholderByTextType(int type)
    {
        ...
        {
            if (shape[i] instanceof TextShape tx)
            {
