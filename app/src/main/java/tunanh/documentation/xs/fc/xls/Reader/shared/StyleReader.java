 ...
 * 时间:              下午3:10:35
 */
package tunanh.documentation.xs.fc.xls.Reader.shared;
...
import tunanh.documentation.xs.simpletext.font.Font;
import tunanh.documentation.xs.ss.model.baseModel.Workbook;
import tunanh.documentation.xs.ss.model.sheetProperty.Palette;
import tunanh.documentation.xs.ss.model.style.BorderStyle;
import tunanh.documentation.xs.ss.model.style.BuiltinFormats;
import tunanh.documentation.xs.ss.model.style.CellBorder;
import tunanh.documentation.xs.ss.model.style.CellStyle;
import tunanh.documentation.xs.ss.model.style.NumberFormat;
import tunanh.documentation.xs.ss.model.table.TableFormatManager;
import tunanh.documentation.xs.ss.util.ColorUtil;
import tunanh.documentation.xs.system.AbortReaderError;
import tunanh.documentation.xs.system.IReader;
    ...
    class StyleSaxHandler implements ElementHandler
    {
        ...
        public void onEnd(ElementPath elementPath)
        {
            ...
            switch (name) {
                ...
                case "font" -> book.addFont(fontIndex++, processFont(elem));
                case "fill" -> fills.put(fillIndex++, processFill(elem));
                case "border" -> cellBorders.put(borderIndex++, processBorder(elem));
                case "xf" -> book.addCellStyle(styleIndex++, processCellStyle(elem));
                case "rgbColor" -> book.addColor(indexedColor++, processIndexedColors(elem));
                case "dxf" -> processTableFormat(elem);
            }
