 ...
 * </p>
 * 
 * @deprecated use {@link   tunanh.documentation.xs.fc.ss.util.CellRangeAddressList}
 * 
 * @author Dragos Buleandra (dragos.buleandra@trade2b.ro)
 */
public class CellRangeAddressList extends   tunanh.documentation.xs.fc.ss.util.CellRangeAddressList {
