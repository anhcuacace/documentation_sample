 ...
 * @author Yegor Kozlov
 */
public final class ShapeTypes implements tunanh.documentation.xs.common.shape.ShapeTypes
{
    /**
    ...
    static
    {
        ...
        try
        {
            Field[] f = tunanh.documentation.xs.common.shape.ShapeTypes.class.getFields();
