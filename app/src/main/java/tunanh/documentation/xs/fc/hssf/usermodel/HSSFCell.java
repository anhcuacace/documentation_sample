...
import tunanh.documentation.xs.fc.hssf.record.CommonObjectDataSubRecord;
...
import tunanh.documentation.xs.fc.ss.usermodel.Comment;
import tunanh.documentation.xs.fc.ss.usermodel.FormulaError;
import tunanh.documentation.xs.fc.ss.usermodel.ICell;
import tunanh.documentation.xs.fc.ss.usermodel.ICellStyle;
import tunanh.documentation.xs.fc.ss.usermodel.IHyperlink;
import tunanh.documentation.xs.fc.ss.usermodel.RichTextString;
import tunanh.documentation.xs.fc.ss.util.CellReference;
import tunanh.documentation.xs.fc.ss.util.HSSFCellRangeAddress;
import tunanh.documentation.xs.fc.ss.util.NumberToTextConverter;
...
public class HSSFCell implements ICell {
     ...
     *
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFRow#createCell(short)
     */
     ...
     *                Type of cell
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFRow#createCell(short,int)
     */
...
//        agg.setParsedExpression(ptgs);
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#createCellStyle()
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
     */
    ...
    protected static HSSFComment findCellComment(InternalSheet sheet, int row, int column) {
        ...
        for (Iterator<RecordBase> it = sheet.getRecords().iterator(); it.hasNext();) {
            ...
            if (rec instanceof NoteRecord note) {
                ...
                i++;
            } else if (rec instanceof ObjRecord obj) {
                SubRecord sub = obj.getSubRecords().get(0);
                if (sub instanceof CommonObjectDataSubRecord cmo) {
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFSheet#shiftRows(int, int, int)
