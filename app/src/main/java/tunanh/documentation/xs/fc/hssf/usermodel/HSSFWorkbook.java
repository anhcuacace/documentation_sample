...
import tunanh.documentation.xs.fc.POIDocument;
import tunanh.documentation.xs.fc.codec.DigestUtils;
import tunanh.documentation.xs.fc.ddf.EscherBSERecord;
import tunanh.documentation.xs.fc.ddf.EscherBitmapBlip;
import tunanh.documentation.xs.fc.ddf.EscherBlipRecord;
import tunanh.documentation.xs.fc.ddf.EscherRecord;
import tunanh.documentation.xs.fc.hssf.OldExcelFormatException;
import tunanh.documentation.xs.fc.hssf.formula.FormulaShifter;
import tunanh.documentation.xs.fc.hssf.formula.SheetNameFormatter;
import tunanh.documentation.xs.fc.hssf.formula.ptg.Area3DPtg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.MemFuncPtg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.Ptg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.UnionPtg;
import tunanh.documentation.xs.fc.hssf.formula.udf.AggregatingUDFFinder;
import tunanh.documentation.xs.fc.hssf.formula.udf.UDFFinder;
import tunanh.documentation.xs.fc.hssf.model.DrawingManager2;
...
import tunanh.documentation.xs.fc.hssf.record.AbstractEscherHolderRecord;
...
import tunanh.documentation.xs.fc.hssf.record.EmbeddedObjectRefSubRecord;
...
import tunanh.documentation.xs.fc.hssf.record.SubRecord;
...
import tunanh.documentation.xs.fc.hssf.util.CellReference;
...
import tunanh.documentation.xs.fc.ss.usermodel.IRow.MissingCellPolicy;
import tunanh.documentation.xs.fc.ss.util.WorkbookUtil;
 ...
 */
public final class HSSFWorkbook extends POIDocument implements   tunanh.documentation.xs.fc.ss.usermodel.Workbook
{
    ...
    private List<HSSFSheet> _sheets;
...
//            names.add(name);
    ...
    /**
      ...
      * @see   tunanh.documentation.xs.fc.hssf.record.LabelRecord
      * @see   tunanh.documentation.xs.fc.hssf.record.LabelSSTRecord
      * @see   tunanh.documentation.xs.fc.hssf.record.SSTRecord
      */
     ...
     * @see   tunanh.documentation.xs.fc.hssf.usermodel.HSSFSheet#setSelected(boolean)
     */
     ...
     * @see {@link   tunanh.documentation.xs.fc.ss.util.WorkbookUtil#createSafeSheetName(String nameProposal)}
     ...
     */
    public int getSheetIndex(  tunanh.documentation.xs.fc.ss.usermodel.Sheet sheet)
    {
...
//        return newName;
     ...
     * @see   tunanh.documentation.xs.fc.hssf.record.FormatRecord
     * @see   tunanh.documentation.xs.fc.hssf.record.Record
     */
