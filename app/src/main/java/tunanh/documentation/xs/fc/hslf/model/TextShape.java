...
import tunanh.documentation.xs.fc.hslf.record.InteractiveInfo;
import tunanh.documentation.xs.fc.hslf.record.InteractiveInfoAtom;
import tunanh.documentation.xs.fc.hslf.record.OEPlaceholderAtom;
import tunanh.documentation.xs.fc.hslf.record.OutlineTextRefAtom;
...
import tunanh.documentation.xs.fc.hslf.record.TextRulerAtom;
import tunanh.documentation.xs.fc.hslf.record.TxInteractiveInfoAtom;
...
public abstract class TextShape extends SimpleShape
{
    ...
    */
     ...
     * @see tunanh.documentation.xs.fc.hslf.usermodel.SlideShow#addHyperlink(Hyperlink)
     */
