...
import tunanh.documentation.xs.fc.hssf.formula.CollaboratingWorkbooksEnvironment;
import tunanh.documentation.xs.fc.hssf.formula.IStabilityClassifier;
import tunanh.documentation.xs.fc.hssf.formula.WorkbookEvaluator;
...
import tunanh.documentation.xs.fc.ss.usermodel.CellValue;
import tunanh.documentation.xs.fc.ss.usermodel.FormulaEvaluator;
import tunanh.documentation.xs.fc.ss.usermodel.ICell;
import tunanh.documentation.xs.fc.ss.usermodel.Workbook;
...
public class HSSFFormulaEvaluator implements FormulaEvaluator
{
     ...
     * replaced with the result of the formula, use
