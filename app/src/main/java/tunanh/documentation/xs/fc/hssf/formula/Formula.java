...
import tunanh.documentation.xs.fc.hssf.formula.ptg.TblPtg;
import tunanh.documentation.xs.fc.ss.util.CellReference;
import tunanh.documentation.xs.fc.util.LittleEndian;
import tunanh.documentation.xs.fc.util.LittleEndianByteArrayInputStream;
...
public class Formula {
	...
	/**
	 * Gets the locator for the corresponding {@link tunanh.documentation.xs.fc.hssf.record.SharedFormulaRecord},
     * {@link tunanh.documentation.xs.fc.hssf.record.ArrayRecord} or {@link tunanh.documentation.xs.fc.hssf.record.TableRecord}
