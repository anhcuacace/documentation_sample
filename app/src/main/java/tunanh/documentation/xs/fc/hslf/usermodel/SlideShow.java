...
package tunanh.documentation.xs.fc.hslf.usermodel;
...
import tunanh.documentation.xs.fc.hslf.exceptions.CorruptPowerPointFileException;
import tunanh.documentation.xs.fc.hslf.model.HeadersFooters;
import tunanh.documentation.xs.fc.hslf.model.Hyperlink;
import tunanh.documentation.xs.fc.hslf.model.MovieShape;
...
import tunanh.documentation.xs.fc.hslf.record.ExAviMovie;
import tunanh.documentation.xs.fc.hslf.record.ExControl;
import tunanh.documentation.xs.fc.hslf.record.ExHyperlink;
import tunanh.documentation.xs.fc.hslf.record.ExHyperlinkAtom;
import tunanh.documentation.xs.fc.hslf.record.ExMCIMovie;
import tunanh.documentation.xs.fc.hslf.record.ExObjList;
import tunanh.documentation.xs.fc.hslf.record.ExObjListAtom;
import tunanh.documentation.xs.fc.hslf.record.ExOleObjAtom;
import tunanh.documentation.xs.fc.hslf.record.ExVideoContainer;
import tunanh.documentation.xs.fc.hslf.record.ExtendedParagraphHeaderAtom;
import tunanh.documentation.xs.fc.hslf.record.ExtendedPresRuleContainer;
import tunanh.documentation.xs.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import tunanh.documentation.xs.fc.hslf.record.FontCollection;
import tunanh.documentation.xs.fc.hslf.record.HeadersFootersContainer;
import tunanh.documentation.xs.fc.hslf.record.PersistPtrHolder;
import tunanh.documentation.xs.fc.hslf.record.PositionDependentRecord;
...
import tunanh.documentation.xs.fc.hslf.record.RecordContainer;
import tunanh.documentation.xs.fc.hslf.record.RecordTypes;
import tunanh.documentation.xs.fc.hslf.record.SlideListWithText;
import tunanh.documentation.xs.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import tunanh.documentation.xs.fc.hslf.record.SlidePersistAtom;
...
public final class SlideShow
{
    ...
    private void findMostRecentCoreRecords()
    {
        ...
        {
            if (_records[i] instanceof PersistPtrHolder pph)
            {
        ...
        for (int i = 0; i < _records.length; i++)
        {
            if (_records[i] instanceof PositionDependentRecord pdr)
            {
    ...
    private void buildSlidesAndNotes()
    {
        ...
        if (masterSLWT != null)
        {
            ...
            for (int i = 0; i < masterSets.length; i++)
            {
                ...
                if (r instanceof   tunanh.documentation.xs.fc.hslf.record.Slide)
                {
                    TitleMaster master = new TitleMaster((  tunanh.documentation.xs.fc.hslf.record.Slide)r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                }
                else if (r instanceof   tunanh.documentation.xs.fc.hslf.record.MainMaster)
                {
                    SlideMaster master = new SlideMaster((  tunanh.documentation.xs.fc.hslf.record.MainMaster)r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        // notesSLWT
          tunanh.documentation.xs.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null)
        {
            // None
            notesRecords = new   tunanh.documentation.xs.fc.hslf.record.Notes[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<  tunanh.documentation.xs.fc.hslf.record.Notes> notesRecordsL = new ArrayList<  tunanh.documentation.xs.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++)
            {
                ...
                if (r instanceof tunanh.documentation.xs.fc.hslf.record.Notes notesRecord)
                {
            ...
            notesRecords = new   tunanh.documentation.xs.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        // Now, do the same thing for our slides
          tunanh.documentation.xs.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null)
        {
            // None
            slidesRecords = new   tunanh.documentation.xs.fc.hslf.record.Slide[0];
        }
        else
        {
            // Match up the records and the SlideAtomSets
            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new   tunanh.documentation.xs.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++)
            {
                ...
                if (r instanceof   tunanh.documentation.xs.fc.hslf.record.Slide)
                {
                    slidesRecords[i] = (  tunanh.documentation.xs.fc.hslf.record.Slide)r;
                }
                /*else
                {
    ...
    {
        DocumentAtom docatom = _documentRecord.getDocumentAtom();
        docatom.setSlideSizeX((long)((long) pgsize.width * ShapeKit.MASTER_DPI / MainConstant.POINT_DPI));
        docatom.setSlideSizeY((long)((long) pgsize.height * ShapeKit.MASTER_DPI / MainConstant.POINT_DPI));
    }
