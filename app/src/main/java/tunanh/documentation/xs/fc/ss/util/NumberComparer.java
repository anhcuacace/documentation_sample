...
import static tunanh.documentation.xs.fc.ss.util.IEEEDouble.BIASED_EXPONENT_SPECIAL_VALUE;
import static tunanh.documentation.xs.fc.ss.util.IEEEDouble.EXPONENT_BIAS;
import static tunanh.documentation.xs.fc.ss.util.IEEEDouble.FRAC_MASK;
import static tunanh.documentation.xs.fc.ss.util.IEEEDouble.getBiasedExponent;
