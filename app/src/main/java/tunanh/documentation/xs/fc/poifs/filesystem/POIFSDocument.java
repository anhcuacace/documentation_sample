...
import tunanh.documentation.xs.fc.poifs.property.DocumentProperty;
import tunanh.documentation.xs.fc.poifs.property.Property;
import tunanh.documentation.xs.fc.poifs.storage.BlockWritable;
import tunanh.documentation.xs.fc.poifs.storage.DataInputBlock;
import tunanh.documentation.xs.fc.poifs.storage.DocumentBlock;
import tunanh.documentation.xs.fc.poifs.storage.ListManagedBlock;
import tunanh.documentation.xs.fc.poifs.storage.RawDataBlock;
import tunanh.documentation.xs.fc.poifs.storage.SmallDocumentBlock;
