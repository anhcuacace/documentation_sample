...
import tunanh.documentation.xs.fc.hpsf.DocumentSummaryInformation;
import tunanh.documentation.xs.fc.hpsf.MutablePropertySet;
import tunanh.documentation.xs.fc.hpsf.PropertySet;
import tunanh.documentation.xs.fc.hpsf.PropertySetFactory;
import tunanh.documentation.xs.fc.hpsf.SummaryInformation;
...
import tunanh.documentation.xs.fc.poifs.filesystem.Entry;
import tunanh.documentation.xs.fc.poifs.filesystem.NPOIFSFileSystem;
...
import tunanh.documentation.xs.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(  tunanh.documentation.xs.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(  tunanh.documentation.xs.fc.hpsf.WritingNotSupportedException wnse)
        {
