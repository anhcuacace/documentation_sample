...
import tunanh.documentation.xs.fc.hslf.model.textproperties.AutoNumberTextProp;
import tunanh.documentation.xs.fc.hslf.model.textproperties.TextPropCollection;
...
import tunanh.documentation.xs.fc.hslf.record.TextSpecInfoAtom;
...
public final class TextRun
{
    ...
    */
    ...
    private void storeText(String s)
    {
        ...
        if (_records != null)
            ...
            {
                if (_records[i] instanceof TextSpecInfoAtom specAtom)
                {
    ...
    * @see tunanh.documentation.xs.fc.hslf.record.TextHeaderAtom
    */
    ...
    */
    ...
    public int getNumberingType(int characterIndex)
    {
        if (_extendedParagraphAtom != null)
        {
            ...
            if (index >= 0)
            {
                ...
                if (paraPropList != null && !paraPropList.isEmpty() && index < paraPropList.size())
                {
    ...
    public int getAutoNumberIndex(int characterIndex)
    {
        if (_records != null)
        {
            for (int i = 0; i < _records.length; i++)
            {
                if (_records[i] instanceof StyleTextPropAtom stp)
                {
                    if (stp != null)
                    {
