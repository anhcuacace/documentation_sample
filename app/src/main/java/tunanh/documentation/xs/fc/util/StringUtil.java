 ...
 *
 * Note - none of the methods in this class deals with {@link tunanh.documentation.xs.fc.hssf.record.ContinueRecord}s.  For such
...
public class StringUtil {
	...
	private static int matchOptionalFormatting(
		...
		if ((!formatting.isEmpty())
			...
			(!formatting.isEmpty()) && (formatting.charAt(0) == '.')) {
