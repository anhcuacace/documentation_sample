...
import tunanh.documentation.xs.fc.ss.usermodel.Name;
...
public final class HSSFName implements Name {
     ...
     * scratch.
     *
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#createName()
    ...
    public String getComment() {
        if(_commentRec != null) {
           ...
           if(_commentRec.getCommentText() != null &&
                   !_commentRec.getCommentText().isEmpty()) {
