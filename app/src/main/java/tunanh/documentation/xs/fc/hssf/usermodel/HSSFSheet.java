...
import tunanh.documentation.xs.fc.hssf.record.AutoFilterInfoRecord;
import tunanh.documentation.xs.fc.hssf.record.CellValueRecordInterface;
import tunanh.documentation.xs.fc.hssf.record.DVRecord;
...
import tunanh.documentation.xs.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import tunanh.documentation.xs.fc.hssf.util.Region;
import tunanh.documentation.xs.fc.ss.SpreadsheetVersion;
import tunanh.documentation.xs.fc.ss.usermodel.CellRange;
import tunanh.documentation.xs.fc.ss.usermodel.DataValidation;
import tunanh.documentation.xs.fc.ss.usermodel.DataValidationHelper;
import tunanh.documentation.xs.fc.ss.usermodel.ICell;
import tunanh.documentation.xs.fc.ss.usermodel.ICellStyle;
import tunanh.documentation.xs.fc.ss.usermodel.IRow;
import tunanh.documentation.xs.fc.ss.util.CellReference;
import tunanh.documentation.xs.fc.ss.util.HSSFCellRangeAddress;
import tunanh.documentation.xs.fc.ss.util.SSCellRange;
import tunanh.documentation.xs.fc.ss.util.SheetUtil;
 ...
 */
public final class HSSFSheet implements tunanh.documentation.xs.fc.ss.usermodel.Sheet
{
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#createSheet()
     */
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFRow
     */
   ...
   public void setColumnPixelWidth(int columnIndex, int width)
   {
     ...
     */
    public int addMergedRegion(tunanh.documentation.xs.fc.ss.util.Region region)
    {
     ...
     *
     *  <p>
     *  Calculating the formula values with {@link tunanh.documentation.xs.fc.ss.usermodel.com.wxiwei.office.fc.ss.usermodel.FormulaEvaluator} is the
