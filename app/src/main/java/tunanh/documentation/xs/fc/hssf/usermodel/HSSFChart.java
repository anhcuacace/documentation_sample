...
import tunanh.documentation.xs.fc.hssf.formula.ptg.AreaPtgBase;
...
import tunanh.documentation.xs.fc.hssf.record.FooterRecord;
import tunanh.documentation.xs.fc.hssf.record.HCenterRecord;
import tunanh.documentation.xs.fc.hssf.record.HeaderRecord;
import tunanh.documentation.xs.fc.hssf.record.PrintSetupRecord;
...
import tunanh.documentation.xs.fc.hssf.record.VCenterRecord;
...
import tunanh.documentation.xs.fc.hssf.record.chart.ChartFormatRecord;
...
import tunanh.documentation.xs.fc.hssf.record.chart.SeriesIndexRecord;
...
import tunanh.documentation.xs.fc.hssf.util.CellRangeAddress;
import tunanh.documentation.xs.fc.ss.util.CellRangeAddressBase;
...
public final class HSSFChart extends HSSFSimpleShape {
	...
	private static int convetRecordsToSeriesByPostion(List<Record> records, HSSFChart chart, int seriesStart)
	{
        ...
        if (records.get(start) instanceof BeginRecord)
        {
            ...
            while(start <= records.size() && beginReocrdsCount > 0)
            {
                ...
                if (r instanceof LinkedDataRecord linkedDataRecord)
                {
	...
	private static int convetRecordsToText(List<Record> records, HSSFChart chart, int seriesStart)
	{
        ...
        if(txtRecord.getWidth() > 0 && txtRecord.getHeight() > 0 
        		&& objLinkRecord != null && !chart.series.isEmpty())
        {
        	if(str != null)
        	{
