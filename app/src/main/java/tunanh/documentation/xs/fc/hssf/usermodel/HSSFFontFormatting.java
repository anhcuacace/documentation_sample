...
import tunanh.documentation.xs.fc.hssf.record.CFRuleRecord;
import tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting;
 ...
 *
 */
public final class HSSFFontFormatting implements tunanh.documentation.xs.fc.ss.usermodel.FontFormatting
{
	...
	/**
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#getRawRecord()
	 */
	...
	/**
	 * @param modified
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setEscapementTypeModified(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setFontCancellationModified(boolean)
	 */
	...
	/**
	 * @param fci
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setFontColorIndex(short)
	 */
	...
	/**
	 * @param height
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setFontHeight(int)
	 */
	...
	/**
	 * @param modified
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setFontOutlineModified(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setFontShadowModified(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setFontStyleModified(boolean)
	 */
	...
	/**
	 * @param on
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setOutline(boolean)
	 */
	...
	/**
	 * @param on
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setShadow(boolean)
	 */
	...
	/**
	 * @param strike
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setStrikeout(boolean)
	 */
	...
	/**
	 * @param modified
	 * @see tunanh.documentation.xs.fc.hssf.record.cf.FontFormatting#setUnderlineTypeModified(boolean)
	 */
