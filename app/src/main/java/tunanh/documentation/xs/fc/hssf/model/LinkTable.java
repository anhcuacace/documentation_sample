...
import tunanh.documentation.xs.fc.hssf.record.CRNCountRecord;
import tunanh.documentation.xs.fc.hssf.record.CRNRecord;
...
import tunanh.documentation.xs.fc.hssf.record.ExternalNameRecord;
...
final class LinkTable {
	...
	private static final class ExternalBookBlock {
         ...
         *
         * @see   tunanh.documentation.xs.fc.hssf.model.LinkTable#LinkTable(int, WorkbookRecordList)
         */
         ...
         *
         * @see   tunanh.documentation.xs.fc.hssf.model.LinkTable#addNameXPtg(String)
         */
