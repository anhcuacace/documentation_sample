...
import tunanh.documentation.xs.fc.hwpf.model.PictureDescriptor;
...
public class InlineWordArt extends PictureDescriptor
{
	...
	{
		if(escherRecords != null && !escherRecords.isEmpty() && escherRecords.get(0) instanceof EscherContainerRecord)
	    {
