...
package tunanh.documentation.xs.fc.hssf.model;
...
import tunanh.documentation.xs.fc.ddf.EscherBSERecord;
import tunanh.documentation.xs.fc.ddf.EscherBoolProperty;
import tunanh.documentation.xs.fc.ddf.EscherContainerRecord;
import tunanh.documentation.xs.fc.ddf.EscherDgRecord;
import tunanh.documentation.xs.fc.ddf.EscherDggRecord;
import tunanh.documentation.xs.fc.ddf.EscherOptRecord;
import tunanh.documentation.xs.fc.ddf.EscherProperties;
import tunanh.documentation.xs.fc.ddf.EscherRGBProperty;
import tunanh.documentation.xs.fc.ddf.EscherRecord;
import tunanh.documentation.xs.fc.ddf.EscherSimpleProperty;
import tunanh.documentation.xs.fc.ddf.EscherSpRecord;
import tunanh.documentation.xs.fc.ddf.EscherSplitMenuColorsRecord;
import tunanh.documentation.xs.fc.hssf.formula.EvaluationWorkbook.ExternalName;
import tunanh.documentation.xs.fc.hssf.formula.EvaluationWorkbook.ExternalSheet;
import tunanh.documentation.xs.fc.hssf.formula.FormulaShifter;
import tunanh.documentation.xs.fc.hssf.formula.ptg.Area3DPtg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.NameXPtg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.OperandPtg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.Ptg;
import tunanh.documentation.xs.fc.hssf.formula.ptg.Ref3DPtg;
import tunanh.documentation.xs.fc.hssf.formula.udf.UDFFinder;
import tunanh.documentation.xs.fc.hssf.record.BOFRecord;
import tunanh.documentation.xs.fc.hssf.record.BackupRecord;
import tunanh.documentation.xs.fc.hssf.record.BookBoolRecord;
import tunanh.documentation.xs.fc.hssf.record.BoundSheetRecord;
import tunanh.documentation.xs.fc.hssf.record.CodepageRecord;
import tunanh.documentation.xs.fc.hssf.record.CountryRecord;
import tunanh.documentation.xs.fc.hssf.record.DSFRecord;
import tunanh.documentation.xs.fc.hssf.record.DateWindow1904Record;
import tunanh.documentation.xs.fc.hssf.record.DrawingGroupRecord;
import tunanh.documentation.xs.fc.hssf.record.EOFRecord;
import tunanh.documentation.xs.fc.hssf.record.EscherAggregate;
import tunanh.documentation.xs.fc.hssf.record.ExtSSTRecord;
import tunanh.documentation.xs.fc.hssf.record.ExtendedFormatRecord;
import tunanh.documentation.xs.fc.hssf.record.ExternSheetRecord;
import tunanh.documentation.xs.fc.hssf.record.FileSharingRecord;
import tunanh.documentation.xs.fc.hssf.record.FnGroupCountRecord;
import tunanh.documentation.xs.fc.hssf.record.FontRecord;
import tunanh.documentation.xs.fc.hssf.record.FormatRecord;
import tunanh.documentation.xs.fc.hssf.record.HideObjRecord;
import tunanh.documentation.xs.fc.hssf.record.HyperlinkRecord;
import tunanh.documentation.xs.fc.hssf.record.InterfaceEndRecord;
import tunanh.documentation.xs.fc.hssf.record.InterfaceHdrRecord;
import tunanh.documentation.xs.fc.hssf.record.MMSRecord;
import tunanh.documentation.xs.fc.hssf.record.NameCommentRecord;
import tunanh.documentation.xs.fc.hssf.record.NameRecord;
import tunanh.documentation.xs.fc.hssf.record.PaletteRecord;
import tunanh.documentation.xs.fc.hssf.record.PasswordRecord;
import tunanh.documentation.xs.fc.hssf.record.PasswordRev4Record;
import tunanh.documentation.xs.fc.hssf.record.PrecisionRecord;
import tunanh.documentation.xs.fc.hssf.record.ProtectRecord;
import tunanh.documentation.xs.fc.hssf.record.ProtectionRev4Record;
import tunanh.documentation.xs.fc.hssf.record.RecalcIdRecord;
import tunanh.documentation.xs.fc.hssf.record.Record;
import tunanh.documentation.xs.fc.hssf.record.RefreshAllRecord;
import tunanh.documentation.xs.fc.hssf.record.SSTRecord;
import tunanh.documentation.xs.fc.hssf.record.StyleRecord;
import tunanh.documentation.xs.fc.hssf.record.SupBookRecord;
import tunanh.documentation.xs.fc.hssf.record.TabIdRecord;
import tunanh.documentation.xs.fc.hssf.record.UseSelFSRecord;
import tunanh.documentation.xs.fc.hssf.record.WindowOneRecord;
import tunanh.documentation.xs.fc.hssf.record.WindowProtectRecord;
import tunanh.documentation.xs.fc.hssf.record.WriteAccessRecord;
import tunanh.documentation.xs.fc.hssf.record.WriteProtectRecord;
import tunanh.documentation.xs.fc.hssf.record.common.UnicodeString;
import tunanh.documentation.xs.fc.hssf.util.HSSFColor;
import tunanh.documentation.xs.fc.ss.usermodel.BuiltinFormats;
 ...
 * @see   tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook
 */
@ Internal
public final class InternalWorkbook
{
    ...
    */
    ...
    public void cloneDrawings(InternalSheet sheet)
    {
        ...
        if (aggLoc != -1)
        {
            ...
            for (Iterator<EscherRecord> it = escherContainer.getChildIterator(); it.hasNext();)
            {
                ...
                else if (er instanceof EscherContainerRecord cp)
                {
     ...
     *
     * @see   tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#setForceFormulaRecalculation(boolean)
     */
