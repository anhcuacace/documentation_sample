...
public final class TitleMaster extends MasterSheet
{
     ...
     *
     */
    public TitleMaster(tunanh.documentation.xs.fc.hslf.record.Slide record, int sheetNo)
    {
    ...
    public MasterSheet getMasterSheet()
    {
        ...
        SlideAtom sa = ((tunanh.documentation.xs.fc.hslf.record.Slide)getSheetContainer()).getSlideAtom();
