...
import tunanh.documentation.xs.fc.ss.usermodel.IFont;
 ...
 * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(tunanh.documentation.xs.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(tunanh.documentation.xs.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(tunanh.documentation.xs.fc.ss.usermodel.Workbook parentWorkbook) {
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == tunanh.documentation.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (tunanh.documentation.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(tunanh.documentation.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == tunanh.documentation.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != tunanh.documentation.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(tunanh.documentation.xs.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
