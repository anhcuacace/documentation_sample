...
import tunanh.documentation.xs.common.autoshape.ExtendPath;
...
import tunanh.documentation.xs.common.bg.Gradient;
import tunanh.documentation.xs.common.bg.LinearGradientShader;
import tunanh.documentation.xs.common.bg.RadialGradientShader;
import tunanh.documentation.xs.common.bg.TileShader;
...
import tunanh.documentation.xs.common.shape.TableCell;
import tunanh.documentation.xs.common.shape.TableShape;
import tunanh.documentation.xs.common.shape.TextBox;
import tunanh.documentation.xs.constant.AutoShapeConstant;
import tunanh.documentation.xs.constant.EventConstant;
import tunanh.documentation.xs.constant.MainConstant;
import tunanh.documentation.xs.constant.wp.WPAttrConstant;
import tunanh.documentation.xs.constant.wp.WPModelConstant;
import tunanh.documentation.xs.fc.FCKit;
import tunanh.documentation.xs.fc.ShapeKit;
import tunanh.documentation.xs.fc.hslf.HSLFSlideShow;
import tunanh.documentation.xs.fc.hslf.model.Fill;
import tunanh.documentation.xs.fc.hslf.model.HeadersFooters;
import tunanh.documentation.xs.fc.hslf.model.Line;
import tunanh.documentation.xs.fc.hslf.model.MasterSheet;
import tunanh.documentation.xs.fc.hslf.model.Notes;
import tunanh.documentation.xs.fc.hslf.model.Shape;
import tunanh.documentation.xs.fc.hslf.model.ShapeGroup;
import tunanh.documentation.xs.fc.hslf.model.Sheet;
import tunanh.documentation.xs.fc.hslf.model.SimpleShape;
import tunanh.documentation.xs.fc.hslf.model.Slide;
import tunanh.documentation.xs.fc.hslf.model.SlideMaster;
import tunanh.documentation.xs.fc.hslf.model.TextShape;
import tunanh.documentation.xs.fc.hslf.model.TitleMaster;
import tunanh.documentation.xs.fc.hslf.record.BinaryTagDataBlob;
import tunanh.documentation.xs.fc.hslf.record.ClientVisualElementContainer;
import tunanh.documentation.xs.fc.hslf.record.DocumentAtom;
import tunanh.documentation.xs.fc.hslf.record.OEPlaceholderAtom;
import tunanh.documentation.xs.fc.hslf.record.PositionDependentRecordContainer;
import tunanh.documentation.xs.fc.hslf.record.Record;
import tunanh.documentation.xs.fc.hslf.record.SlideAtom;
import tunanh.documentation.xs.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import tunanh.documentation.xs.fc.hslf.record.SlideProgBinaryTagContainer;
import tunanh.documentation.xs.fc.hslf.record.SlideProgTagsContainer;
import tunanh.documentation.xs.fc.hslf.record.SlideShowSlideInfoAtom;
import tunanh.documentation.xs.fc.hslf.record.TimeAnimateBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeColorBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeCommandBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeEffectBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeMotionBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeNodeAttributeContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeNodeContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeRotationBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeScaleBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeSetBehaviorContainer;
import tunanh.documentation.xs.fc.hslf.record.TimeVariant;
import tunanh.documentation.xs.fc.hslf.record.VisualShapeAtom;
import tunanh.documentation.xs.fc.hslf.usermodel.PictureData;
import tunanh.documentation.xs.fc.hslf.usermodel.RichTextRun;
import tunanh.documentation.xs.fc.hslf.usermodel.SlideShow;
import tunanh.documentation.xs.fc.ppt.bulletnumber.BulletNumberManage;
import tunanh.documentation.xs.java.awt.Dimension;
import tunanh.documentation.xs.java.awt.Rectangle;
import tunanh.documentation.xs.java.awt.Rectanglef;
import tunanh.documentation.xs.java.awt.geom.Rectangle2D;
import tunanh.documentation.xs.pg.animate.ShapeAnimation;
import tunanh.documentation.xs.pg.model.PGModel;
import tunanh.documentation.xs.pg.model.PGNotes;
import tunanh.documentation.xs.pg.model.PGSlide;
import tunanh.documentation.xs.simpletext.font.FontTypefaceManage;
...
import tunanh.documentation.xs.ss.util.format.NumericFormatter;
import tunanh.documentation.xs.system.AbstractReader;
import tunanh.documentation.xs.system.BackReaderThread;
...
{   
    ...
    {
        if (styleShape != null && text != null && !text.isEmpty())
        {
    ...
    private tunanh.documentation.xs.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private tunanh.documentation.xs.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        tunanh.documentation.xs.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             tunanh.documentation.xs.java.awt.Color color = shape.getLineColor();
             
             if(color != null)
             {
            	 line = new tunanh.documentation.xs.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	tunanh.documentation.xs.java.awt.Color fillColor = fill.getForegroundColor();
            	tunanh.documentation.xs.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof tunanh.documentation.xs.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof tunanh.documentation.xs.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof tunanh.documentation.xs.fc.hslf.model.Freeform
            || shape instanceof tunanh.documentation.xs.fc.hslf.model.AutoShape
            || shape instanceof tunanh.documentation.xs.fc.hslf.model.TextBox
            || shape instanceof tunanh.documentation.xs.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof tunanh.documentation.xs.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((tunanh.documentation.xs.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((tunanh.documentation.xs.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((tunanh.documentation.xs.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof tunanh.documentation.xs.fc.hslf.model.AutoShape
                    || shape instanceof tunanh.documentation.xs.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof tunanh.documentation.xs.fc.hslf.model.Picture poiPic)
            {
        ...
        else if(shape instanceof tunanh.documentation.xs.fc.hslf.model.Table poiTable)
        {
            if (poiTable != null)
            {
        ...
        else if (shape instanceof ShapeGroup shapeGroup)
        {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, tunanh.documentation.xs.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                tunanh.documentation.xs.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	tunanh.documentation.xs.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            tunanh.documentation.xs.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && !text.trim().isEmpty())
        {
            ...
            int len = text.length();
            tunanh.documentation.xs.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != tunanh.documentation.xs.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  tunanh.documentation.xs.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        tunanh.documentation.xs.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
        ...
        boolean handleReturn = ts.getTextRun().getRunType() == tunanh.documentation.xs.fc.hslf.record.TextHeaderAtom.TITLE_TYPE;
        while (start < end)
        {
            if (abortReader)
            {
...
//      }
     ...
     * 
     */
    private int converterColor(tunanh.documentation.xs.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
