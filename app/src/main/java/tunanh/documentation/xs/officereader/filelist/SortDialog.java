 ...
 * 时间:              上午10:44:46
 */
package tunanh.documentation.xs.officereader.filelist;
...
import tunanh.documentation.xs.officereader.beans.SingleChoiceList;
import tunanh.documentation.xs.system.IControl;
import tunanh.documentation.xs.system.IDialogAction;
import tunanh.documentation.xs.system.beans.ADialog;
...
public class SortDialog extends ADialog
{
    ...
    public void doLayout()
    {
        ...
        //sortGroup        
        params = new LayoutParams(mWidth / 2, LayoutParams.WRAP_CONTENT);        
        sortGroup.getChildAt(0).setLayoutParams(params);
        sortGroup.getChildAt(1).setLayoutParams(params);
    ...
    public void onClick(View v)
    {
        if (v == ok)
        {
            ...
            int childPos = sortGroup.indexOfChild(sortGroup.findViewById(checkedID));
