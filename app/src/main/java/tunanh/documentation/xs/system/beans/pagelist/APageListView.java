...
public class APageListView extends AdapterView<Adapter>
{
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        for (int i = 0; i < n; i++)
        {
            ...
            if (view instanceof APageListItem pv)
            {
    ...
    public float getFitZoom(int value)
    {
        ...
        float maxZoom = (float) MainConstant.MAXZOOM / MainConstant.STANDARD_RATE;
    	if (value == 0)
        {
    ...
    private APageListItem createPageView(int pageIndex)
    {
        ...
        if (pageView == null)
        {
            pageView = (APageListItem)pageAdapter.getView(pageIndex, 
                (pageViewCache.isEmpty() ?  null : pageViewCache.removeFirst()), this);
