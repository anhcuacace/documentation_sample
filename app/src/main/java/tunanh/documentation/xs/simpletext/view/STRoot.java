 ...
 * 时间:              下午5:22:20
 */
package tunanh.documentation.xs.simpletext.view;
...
import tunanh.documentation.xs.wp.view.LineView;
import tunanh.documentation.xs.wp.view.ParagraphView;
import tunanh.documentation.xs.wp.view.ViewFactory;
