...
package tunanh.documentation.xs.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link   tunanh.documentation.xs.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link   tunanh.documentation.xs.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see   tunanh.documentation.xs.fc.hwpf.usermodel.Shape
 * @see   tunanh.documentation.xs.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
