...
package tunanh.documentation.xs.java.awt;
...
public class Color implements java.io.Serializable
{
     ...
     * @see        tunanh.documentation.xs.java.awt.Color#darker
     * @since      JDK1.0
     */
     ...
     * @see        tunanh.documentation.xs.java.awt.Color#brighter
     * @since      JDK1.0
     */
    public Color darker()
    {
     ...
     * @see      tunanh.documentation.xs.java.awt.Color#Color(int)
     * @since    JDK1.0
     */
     ...
     * @see       tunanh.documentation.xs.java.awt.Color#getRGB()
     * @see       tunanh.documentation.xs.java.awt.Color#Color(int)
     * @since     JDK1.0
     */
