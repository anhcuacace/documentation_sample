...
package tunanh.documentation.xs.java.util;
...
public class Arrays
{
    ...
    private static int binarySearch0(double[] a, int fromIndex, int toIndex, double key)
    {
        ...
        while (low <= high)
        {
            ...
            else
            {
                ...
                // Values are equal
                // (-0.0, 0.0) or (!NaN, NaN)
                cmp = (Long.compare(midBits, keyBits)); // (0.0, -0.0) or (NaN, !NaN)
            }
    ...
    private static int binarySearch0(float[] a, int fromIndex, int toIndex, float key)
    {
        ...
        while (low <= high)
        {
            ...
            else
            {
                ...
                // Values are equal
                // (-0.0, 0.0) or (!NaN, NaN)
                cmp = (Integer.compare(midBits, keyBits)); // (0.0, -0.0) or (NaN, !NaN)
            }
    ...
    {
        T[] copy = (Objects.equals(newType, Object[].class)) ? (T[])new Object[newLength]
        ...
        Class< ? extends T[]> newType)
    {
        ...
        T[] copy;
        copy = (Objects.equals(newType, Object[].class)) ? (T[])new Object[newLength]
            : (T[])Array.newInstance(newType.getComponentType(), newLength);
