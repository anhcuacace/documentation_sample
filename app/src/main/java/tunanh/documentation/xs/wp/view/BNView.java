...
import tunanh.documentation.xs.common.bulletnumber.ListKit;
...
import tunanh.documentation.xs.simpletext.view.AbstractView;
import tunanh.documentation.xs.simpletext.view.CharAttr;
...
public class BNView extends AbstractView/* implements IMemObj*/
{
    ...
    public void draw(Canvas canvas, int originX, int originY, float zoom)
    {
        ...
        if (content != null && content instanceof String text)
        {
