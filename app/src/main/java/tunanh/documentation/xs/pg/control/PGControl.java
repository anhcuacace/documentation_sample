    ...
    public void actionEvent(int actionID, final Object obj)
    {
        switch (actionID)
        {
            ...
            case EventConstant.PG_NOTE_ID:                          //show notes
                ...
                vector.add(text);
                new   tunanh.documentation.xs.pg.dialog.NotesDialog(this, getMainFrame().getActivity(), null, vector,
...
//            safeAsyncTask.execute((Void)null);
    ...
    public void showSlidePage(int i) {
        if (this.pgView != null) {
            showSlide(i);
        }
    }
