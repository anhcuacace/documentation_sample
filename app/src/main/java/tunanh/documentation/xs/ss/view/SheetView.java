...
import tunanh.documentation.xs.simpletext.model.IElementCollection;
...
import tunanh.documentation.xs.ss.model.sheetProperty.ColumnInfo;
...
import tunanh.documentation.xs.ss.other.ExpandedCellRangeAddress;
import tunanh.documentation.xs.ss.other.FindingMgr;
import tunanh.documentation.xs.ss.other.FocusCell;
import tunanh.documentation.xs.ss.other.SheetScroller;
        ...
        {                        
            ...
            if(cell == null || 
                (cell.getRangeAddressIndex() < 0 && 
                    ((content = ModelUtil.instance().getFormatContents(sheet.getWorkbook(), cell)) == null || content.isEmpty())))
            {
