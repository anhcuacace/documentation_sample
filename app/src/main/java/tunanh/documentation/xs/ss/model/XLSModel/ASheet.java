 ...
 * 时间:              下午1:55:20
 */
package tunanh.documentation.xs.ss.model.XLSModel;
...
import tunanh.documentation.xs.constant.SSConstant;
...
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFAutoShape;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFChart;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFChildAnchor;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFClientAnchor;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFFreeform;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFLine;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFPatriarch;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFPicture;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFPictureData;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFRichTextString;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFShape;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFShapeGroup;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFSheet;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFTextbox;
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFWorkbook;
...
import tunanh.documentation.xs.fc.xls.ChartConverter;
import tunanh.documentation.xs.java.awt.Rectangle;
import tunanh.documentation.xs.ss.model.CellRangeAddress;
import tunanh.documentation.xs.ss.model.baseModel.Cell;
import tunanh.documentation.xs.ss.model.baseModel.Row;
import tunanh.documentation.xs.ss.model.baseModel.Sheet;
import tunanh.documentation.xs.ss.model.baseModel.Workbook;
import tunanh.documentation.xs.ss.model.drawing.AnchorPoint;
import tunanh.documentation.xs.ss.model.drawing.CellAnchor;
import tunanh.documentation.xs.ss.model.sheetProperty.PaneInformation;
import tunanh.documentation.xs.ss.util.ModelUtil;
import tunanh.documentation.xs.ss.util.SectionElementFactory;
...
import tunanh.documentation.xs.thirdpart.achartengine.chart.RoundChart;
import tunanh.documentation.xs.thirdpart.achartengine.chart.XYChart;
import tunanh.documentation.xs.thirdpart.achartengine.renderers.DefaultRenderer;
 ...
 * <p>
 */
public class ASheet extends Sheet implements tunanh.documentation.xs.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<tunanh.documentation.xs.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<tunanh.documentation.xs.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                tunanh.documentation.xs.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                tunanh.documentation.xs.ss.model.sheetProperty.ColumnInfo columnInfo = new tunanh.documentation.xs.ss.model.sheetProperty.ColumnInfo(
    ...
    private void processHyperlinkfromSheet(InternalSheet sheet)
    {
        ...
        try
        {
            for (Iterator<RecordBase> it = sheet.getRecords().iterator(); it.hasNext(); ) 
            {
                ...
                if (rec instanceof HyperlinkRecord linkRec)
                {
...
//                     }
    ...
    private void processSingleShape(IControl control, GroupShape parent, HSSFShape shape, Rectangle rect)
    {
        ...
        else if(shape instanceof HSSFChart chart)
        {
