...
import tunanh.documentation.xs.fc.hssf.record.StringRecord;
...
import tunanh.documentation.xs.fc.hssf.usermodel.HSSFDataFormatter;
...
public class ACell extends Cell
{
    ...
    private void processSST()
    {
        ...
        if(obj instanceof UnicodeString unicodeString)
        {
...
//            }
     ...
     */
    public ACell(ASheet sheet, int row, short col)
    {
        ...
        setCellType(CELL_TYPE_BLANK, row, col,xfindex);
    }
    ...
    public void setCellFormula(Ptg[] ptgs) 
    {
        ...
        setCellType(CELL_TYPE_FORMULA, row, col, styleIndex);
    ...
    public void setCellType(int cellType, boolean setValue) 
    {
        ...
        short col=record.getColumn();
        short styleIndex= record.getXFIndex();
        setCellType(cellType, row, col, styleIndex);
    }
    ...
    private void setCellType(int cellType, int row, short col, short styleIndex)
    {
...
//        }
    ...
    public void setCellValue(String value)
    {
        ...
        if (richString == null)
        {            
            setCellType(CELL_TYPE_BLANK, row, col, styleIndex);
            return;
        }
