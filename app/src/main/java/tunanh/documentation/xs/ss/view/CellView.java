 ...
 * 时间:              上午10:52:17
 */
package tunanh.documentation.xs.ss.view;
...
import tunanh.documentation.xs.common.bg.AShader;
...
import tunanh.documentation.xs.fc.xls.Reader.SchemeColorUtil;
import tunanh.documentation.xs.simpletext.font.FontKit;
import tunanh.documentation.xs.simpletext.model.AttrManage;
import tunanh.documentation.xs.simpletext.model.AttributeSetImpl;
import tunanh.documentation.xs.simpletext.model.CellLeafElement;
...
import tunanh.documentation.xs.simpletext.model.STDocument;
...
import tunanh.documentation.xs.ss.model.table.SSTable;
import tunanh.documentation.xs.ss.model.table.SSTableCellStyle;
import tunanh.documentation.xs.ss.model.table.SSTableStyle;
import tunanh.documentation.xs.ss.model.table.TableStyleKit;
import tunanh.documentation.xs.ss.other.DrawingCell;
import tunanh.documentation.xs.ss.other.MergeCell;
import tunanh.documentation.xs.ss.other.MergeCellMgr;
		...
		AShader aShader = fill.getShader();
		 if(aShader != null)
		 {
			 ...
			 Matrix m = new Matrix();
		 	 ...
		 	 float offY = rect.top;
		 	 if(aShader instanceof TileShader tileShader)
			 {
		 	 ...
		 	 {
		 		 if(aShader instanceof LinearGradientShader gradient)
		 		 {
                     float focusX = 1f;
		     		float focusY = 1f;
...
//      paint.setColor(color);
    ...
    {   
        ...
        if(replacedByChar || firstPart.isEmpty() || firstPart.equals("-"))
        {                        
            contents = "";
    ...
    {
        int oldColor = paint.getColor();
        if(!content.isEmpty() && cell.getNumberValue() < 0)
        {
