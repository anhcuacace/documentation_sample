 ...
 * 时间:              下午3:23:24
 */
package tunanh.documentation.xs.ss.util;
...
import tunanh.documentation.xs.ss.view.SheetView;
...
public class ModelUtil
{
    ...
    public float getValueX(SheetView sheetview, int columnIndex, float dx)
    {
        ...
        {
            colStart += 1;
            x += (float) (minRowAndColumnInformation.getVisibleColumnWidth() * sheetview.getZoom());
        }
    ...
    public float getValueY(SheetView sheetview, int rowIndex, float dy)
    {
        ...
        {
            rowStart += 1;
            y += (float) (minRowAndColumnInformation.getVisibleRowHeight() * sheetview.getZoom());
        } 
