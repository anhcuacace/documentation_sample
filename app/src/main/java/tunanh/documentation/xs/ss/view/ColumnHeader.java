...
import tunanh.documentation.xs.ss.util.HeaderUtil;
...
public class ColumnHeader
{
    ...
    private void layoutColumnLine(Canvas canvas, int columnStart, float zoom, Paint paint)
    {
        ...
        {
            colIndex += 1;
            x += (float) (minRowAndColumnInformation.getVisibleColumnWidth() * zoom);
        }
    ...
    private void drawFirstVisibleColumn(Canvas canvas, float zoom, Paint paint)
    {
        ...
        float textY = (float) (int) (columnHeaderHeight - Math.ceil(fm.descent - fm.ascent)) / 2;
