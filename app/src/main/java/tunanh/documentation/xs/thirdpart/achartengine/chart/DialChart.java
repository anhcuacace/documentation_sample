...
import tunanh.documentation.xs.thirdpart.achartengine.renderers.DialRenderer.Type;
...
public class DialChart extends RoundChart {
  ...
  public void draw(Canvas canvas, IControl control, int x, int y, int width, int height, Paint paint) {
    ...
    if (mRenderer.isFitLegend()) {
      legendSize = drawLegend(canvas, mRenderer, titles, left, y, width,
              paint);
    }
    ...
    drawLegend(canvas, mRenderer, titles, left, y, width, paint);
  }
