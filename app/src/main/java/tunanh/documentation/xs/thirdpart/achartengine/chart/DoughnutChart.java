...
public class DoughnutChart extends RoundChart {
  ...
  public void draw(Canvas canvas, IControl control, int x, int y, int width, int height, Paint paint) {
    ...
    if (mRenderer.isFitLegend()) {
      legendSize = drawLegend(canvas, mRenderer, categories, left, y, width,
              paint);
    }
    ...
    for (int category = 0; category < cLength; category++) {
      ...
      shortRadius -= (float) (mRadius * decCoef - 2);
    ...
    drawLegend(canvas, mRenderer, categories, left, y, width, paint
    );
  }
