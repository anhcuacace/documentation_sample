...
import tunanh.documentation.xs.common.pictureefftect.PictureCroppedInfo;
import tunanh.documentation.xs.common.pictureefftect.PictureEffectInfo;
import tunanh.documentation.xs.common.pictureefftect.PictureEffectUtil;
       ...
       try
       {
           ...
           if (sBitmap == null)
           {
               ...
               if( imageType == Picture.WMF || imageType == Picture.EMF)
               {
                   ...
                   {
                	   double z = Math.sqrt((double) VectorMaxSize / (w * h));
                	   if(z > VectorMaxZOOM)
                	   {
                		   z = VectorMaxZOOM;
                	   }
