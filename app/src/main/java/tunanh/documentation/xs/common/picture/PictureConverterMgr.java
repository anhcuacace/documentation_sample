...
import tunanh.documentation.xs.thirdpart.emf.util.EMFUtil;
    ...
    public void remove(String path)
    {
    	synchronized(control)
    	{
    		if(convertingPictPathMap != null)
            {
            	...
            	if(updateViewList != null && !updateViewList.isEmpty())
            	{
                ...
                if(convertingPictPathMap.isEmpty())
                {
