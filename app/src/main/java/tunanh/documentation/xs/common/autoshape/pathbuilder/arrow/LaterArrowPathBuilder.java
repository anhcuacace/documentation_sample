 ...
 * 时间:              下午2:43:56
 */
package tunanh.documentation.xs.common.autoshape.pathbuilder.arrow;
...
public class LaterArrowPathBuilder
{
    ...
    private static Path getBentArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left, rect.top + adj2 - (float) adj1 / 2 + adj4);
        s_rect.set(rect.left, rect.top + adj2 - (float) adj1 / 2, rect.left + 2 * adj4, rect.top + adj2 - (float) adj1 / 2 +  2 * adj4);
        path.arcTo(s_rect, 180, 90);
        
        path.lineTo(rect.right - adj3, rect.top + adj2 - (float) adj1 / 2);
        ...
        if(adj4 >= adj1)
        {
            path.lineTo(rect.left + adj4, rect.top + adj2 + (float) adj1 / 2);
            
            s_rect.set(rect.left + adj1, rect.top + adj2 + (float) adj1 / 2, rect.left + 2 * (adj4 - adj1), rect.top + adj2 + (float) adj1 / 2 + 2 * (adj4 - adj1));
            path.arcTo(s_rect, 270, -90);
            path.lineTo(rect.left + adj1, rect.top + adj2 - (float) adj1 / 2 + adj4);
        }
        else
        {
            path.lineTo(rect.left + adj1, rect.top + adj2 + (float) adj1 / 2);
        }
    ...
    private static Path getUturnArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.arcTo(s_rect, 180, 90);
        path.lineTo(rect.right - adj2 + (float) adj1 / 2 - adj4, rect.top);
        
        s_rect.set(rect.right - adj2 + (float) adj1 / 2 - 2 * adj4, rect.top, rect.right - adj2 + (float) adj1 / 2, rect.top + 2 * adj4);
        path.arcTo(s_rect, 270, 90);
        
        path.lineTo(rect.right - adj2 + (float) adj1 / 2, rect.top + adj5 - adj3);
        ...
        if(adj4 >= adj1)
        {
            path.lineTo(rect.right - adj2 - (float) adj1 / 2, rect.top + adj4);
            s_rect.set(rect.right - adj2 - (float) adj1 / 2 - 2 * (adj4 - adj1), rect.top + adj1, rect.right - adj2 - (float) adj1 / 2, rect.top + adj1 + 2 * (adj4 - adj1));
            path.arcTo(s_rect, 0, -90);
            path.lineTo(rect.right - adj2 + (float) adj1 / 2 - adj4, rect.top + adj1);
        ...
        {
            path.lineTo(rect.right - adj2 - (float) adj1 / 2, rect.top + adj1);
    ...
    private static Path getLeftUpArrowPath(AutoShape shape, Rect rect)
    {
        ...
        //right arrow
        path.moveTo(rect.left + adj3, rect.bottom - adj2 + (float) adj1 / 2);
        path.lineTo(rect.left + adj3, rect.bottom);
        path.lineTo(rect.left, rect.bottom - adj2);
        path.lineTo(rect.left + adj3, rect.bottom - 2 * adj2);
        path.lineTo(rect.left + adj3, rect.bottom - adj2 - (float) adj1 / 2);
        path.lineTo(rect.right - adj2 - (float) adj1 / 2, rect.bottom - adj2 - (float) adj1 / 2);
        
        
        //up arrow
        path.lineTo(rect.right - adj2 - (float) adj1 / 2, rect.top + adj3);
    ...
    private static Path getBentUpArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.right - adj2 - (float) adj1 /2, rect.bottom - adj1);
        path.lineTo(rect.right - adj2 - (float) adj1 / 2, rect.top + adj3);
        path.lineTo(rect.right - adj2 * 2, rect.top + adj3);
        path.lineTo(rect.right - adj2, rect.top);
        path.lineTo(rect.right, rect.top + adj3);
        path.lineTo(rect.right - adj2 + (float) adj1 / 2, rect.top + adj3);
        path.lineTo(rect.right - adj2 + (float) adj1 / 2, rect.bottom);
    ...
    private static List<Path> getCurvedRightArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.arcTo(s_rect, 270, -90);
        path.lineTo(rect.left, rect.top + (float) ovalHeight / 2 + adj1);
        ...
        path = new Path();
        path.moveTo(rect.left, rect.top + (float) ovalHeight / 2);
        
        double y = Math.sqrt(Math.pow((double) ovalHeight / 2, 2)  * (Math.pow((double) ovalWidth / 2, 2) - Math.pow(adj3, 2)) / Math.pow((double) ovalWidth / 2, 2));
  
        int angle = (int)(Math.atan(y / adj3) * 180 / Math.PI);       
        
        s_rect.set(rect.left, rect.top, rect.left + ovalWidth, rect.top + ovalHeight);
        path.arcTo(s_rect, 180, -angle);
        path.setLastPoint(rect.right - adj3, rect.top + (float) ovalHeight / 2 + (int)y);
        
        path.lineTo(rect.right - adj3, rect.top + (float) ovalHeight / 2 + (int)y + (float) adj1 / 2 - (float) adj2 / 2);
        path.lineTo(rect.right, rect.bottom - (float) adj2 / 2);
        path.lineTo(rect.right - adj3, rect.top + (float) ovalHeight / 2 + (int)y + (float) adj1 / 2 + (float) adj2 / 2);
        path.lineTo(rect.right - adj3, rect.top + (float) ovalHeight / 2 + (int)y + adj1);
    ...
    private static List<Path> getCurvedLeftArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.moveTo(rect.right, rect.top + (float) ovalHeight / 2);
        ...
        path.setLastPoint(rect.left + adj3, rect.top + (float) ovalHeight / 2 + (int)y);
        path.lineTo(rect.left + adj3, rect.top + (float) ovalHeight / 2 + (int)y + (float) adj1 / 2 - (float) adj2 / 2);
        path.lineTo(rect.left, rect.bottom - (float) adj2 / 2);
        path.lineTo(rect.left + adj3, rect.top + (float) ovalHeight / 2 + (int)y + (float) adj1 / 2 + (float) adj2 / 2);
        path.lineTo(rect.left + adj3, rect.top + (float) ovalHeight / 2 + (int)y + adj1);
        ...
        s_rect.set(rect.right - ovalWidth, rect.top, rect.right, rect.top + ovalHeight);
        path.arcTo(s_rect, 270, 90);
        path.lineTo(rect.right, rect.top + (float) ovalHeight / 2 + adj1);
        s_rect.set(rect.right - ovalWidth, rect.top + adj1, rect.right, rect.top + ovalHeight + adj1);
        path.arcTo(s_rect, 0, -90);
        path.close();
    ...
    private static List<Path> getCurvedUpArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left + ovalHalfWidth + (float)x + (float) adj1 / 2 - (float) adj2 / 2, rect.top + adj3);
        path.lineTo(rect.right - (float) adj2 / 2, rect.top);
        path.lineTo(rect.left + ovalHalfWidth + (float)x + (float) adj1 / 2 + (float) adj2 / 2, rect.top + adj3);
    ...
    private static List<Path> getCurvedDownArrowPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left + ovalHalfWidth + (float)x + (float) adj1 / 2 - (float) adj2 / 2, rect.bottom - adj3);
        path.lineTo(rect.right - (float) adj2 / 2, rect.bottom);
        path.lineTo(rect.left + ovalHalfWidth + (float)x + (float) adj1 / 2 + (float) adj2 / 2, rect.bottom - adj3);
    ...
    private static Path getRightArrowCalloutPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left + adj4, rect.centerY() - (float) adj1 / 2);
        path.lineTo(rect.right - adj3, rect.centerY() - (float) adj1 / 2);
    ...
    private static Path getLeftArrowCalloutPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left + adj3, rect.centerY() - (float) adj1 / 2);
        path.lineTo(rect.right - adj4, rect.centerY() - (float) adj1 / 2);
    ...
    private static Path getUpArrowCalloutPath(AutoShape shape, Rect rect)
    {
        ...
        path.moveTo(rect.centerX(), rect.top);
        path.lineTo(rect.centerX() + adj2, rect.top + adj3);
        path.lineTo(rect.centerX() + (float) adj1 / 2, rect.top + adj3);
        path.lineTo(rect.centerX() + (float) adj1 / 2, rect.bottom - adj4);
    ...
    private static Path getDownArrowCalloutPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.centerX() - adj2, rect.bottom - adj3);
        path.lineTo(rect.centerX() - (float) adj1 / 2, rect.bottom - adj3);
        path.lineTo(rect.centerX() - (float) adj1 / 2, rect.top + adj4);
        path.lineTo(rect.left, rect.top + adj4);
    ...
    private static Path getLeftRightArrowCalloutPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left + adj3, rect.centerY() - (float) adj1 / 2);
        path.lineTo(rect.centerX() - (float) adj4 / 2, rect.centerY() - (float) adj1 / 2);
        path.lineTo(rect.centerX() - (float) adj4 / 2, rect.top);
        ...
        path.lineTo(rect.right - adj3, rect.centerY() + (float) adj1 / 2);
        path.lineTo(rect.centerX() + (float) adj4 / 2, rect.centerY() + (float) adj1 / 2);
        path.lineTo(rect.centerX() + (float) adj4 / 2, rect.bottom);
        path.lineTo(rect.centerX() - (float) adj4 / 2, rect.bottom);
        path.lineTo(rect.centerX() - (float) adj4 / 2, rect.centerY() + (float) adj1 / 2);
    ...
    private static Path getQuadArrowCalloutPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.left + adj3, rect.centerY() - (float) adj1 / 2);
        path.lineTo(rect.centerX() - (float) adj4 / 2, rect.centerY() - (float) adj1 / 2);
        path.lineTo(rect.centerX() - (float) adj4 / 2, rect.centerY() - (float) adj4 / 2);
        path.lineTo(rect.centerX() - (float) adj1 / 2, rect.centerY() - (float) adj4 / 2);
        path.lineTo(rect.centerX() - (float) adj1 / 2, rect.top + adj3);
    ...
    private static Path getCircularArrowPath(AutoShape shape, Rect rect)
    {
        ...
        double offX2 = Math.sqrt(Math.pow((double) adj1 / 2, 2) / (Math.pow(k, 2) + 1));
        ...
        s_rect.set(adj5 - (float) adj1 / 2 -  (float) len / 2, adj5 - (float) adj1 / 2 -  (float) len / 2, (float) len / 2 - adj5 + (float) adj1 / 2, (float) len / 2 - adj5 + (float) adj1 / 2);
