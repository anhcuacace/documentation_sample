 ...
 * 时间:              下午3:01:08
 */
package tunanh.documentation.xs.common.autoshape.pathbuilder.baseshape;
...
public class BaseShapePathBuilder
{
    ...
    private static Path getSunPath(AutoShape shape, Rect rect)
    {
        ...
        path.lineTo(rect.centerX() + (float) rect.width() / 14, rect.top + offY * 0.75f);
        path.lineTo(rect.centerX() - (float) rect.width() / 14, rect.top + offY * 0.75f);
        path.close();
        
        path.moveTo(rect.centerX(), rect.bottom);
        path.lineTo(rect.centerX() - (float) rect.width() / 14, rect.bottom - offY * 0.75f);
        path.lineTo(rect.centerX() + (float) rect.width() / 14, rect.bottom - offY * 0.75f);
        path.close();
        
        //left and right arrow
        path.moveTo(rect.left, rect.centerY());
        path.lineTo(rect.left + offX * 0.75f, rect.centerY() - (float) rect.height() / 14);
        path.lineTo(rect.left + offX * 0.75f, rect.centerY() + (float) rect.height() / 14);
        path.close();
        
        path.moveTo(rect.right, rect.centerY());
        path.lineTo(rect.right - offX * 0.75f, rect.centerY() + (float) rect.height() / 14);
        path.lineTo(rect.right - offX * 0.75f, rect.centerY() - (float) rect.height() / 14);
        path.close();
        ...
        float offLen = (float) (rect.width() + rect.height()) / 28;
