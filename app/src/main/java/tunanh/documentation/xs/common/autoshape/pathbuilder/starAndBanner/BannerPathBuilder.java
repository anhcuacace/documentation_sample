 ...
 * 时间:              下午4:57:48
 */
package tunanh.documentation.xs.common.autoshape.pathbuilder.starAndBanner;
...
import tunanh.documentation.xs.ss.util.ColorUtil;
...
public class BannerPathBuilder
{
    ...
    private static List<ExtendPath> getRibbon2Path(AutoShape shape, Rect rect)
    {
        ...
        if(shape.isAutoShape07())
        {
            if(values != null && values.length == 2)
            {
                ...
                adj2 = Math.round((float) width / 2 * values[1]);
            } 
            else
            {
        ...
        //small oval
        float a = (float) curleS / 4;
        float b = (float) adj1 / 4;
        ...
        path.lineTo(rect.left + curleS, rect.bottom - (float) (height - adj1) / 2);
        ...
        path.lineTo(rect.right - curleS, rect.bottom - (float) (height - adj1) / 2);
    ...
    private static List<ExtendPath> getLeftRightRibbon(AutoShape shape, Rect rect)
    {
        ...
        if(shape.isAutoShape07())
        {
            ...
            Path path = new Path();
            path.moveTo(rect.left, rect.top + (float) arrowHeight / 2);
            path.lineTo(rect.left + adj2, rect.top);
            path.lineTo(rect.left + adj2, rect.top + (float) (arrowHeight - adj1) / 2);
            path.lineTo(rect.centerX(), rect.top + (float) (arrowHeight - adj1) / 2);
            
            path.arcTo(new RectF(rect.centerX() - (float) adj3H / 4, rect.top + (float) (arrowHeight - adj1) / 2, rect.centerX() + (float) adj3H / 4, rect.top + (float) (arrowHeight - adj1) / 2 + (float) adj3V / 2),
                270, 180);
            
            path.arcTo(new RectF(rect.centerX() - (float) adj3H / 4, rect.top + (float) (arrowHeight - adj1) / 2 + (float) adj3V / 2, rect.centerX() + (float) adj3H / 4, rect.top + (float) (arrowHeight - adj1) / 2 + adj3V),
                270, -180);
            
            path.lineTo(rect.right - adj2, rect.bottom - (float) (arrowHeight - adj1) / 2 - adj1);
            path.lineTo(rect.right - adj2, rect.bottom - arrowHeight);
            path.lineTo(rect.right, rect.bottom - (float) arrowHeight / 2);
            path.lineTo(rect.right - adj2, rect.bottom );
            path.lineTo(rect.right - adj2, rect.bottom - (float) (arrowHeight - adj1) / 2);
            
            path.arcTo(new RectF(rect.centerX() - (float) adj3H / 4,
                rect.bottom - (float) (arrowHeight - adj1) / 2 - (float) adj3V / 2,
                rect.centerX() + (float) adj3H / 4,
                rect.bottom - (float) (arrowHeight - adj1) / 2 ),
                90, 90);
            
            path.lineTo(rect.centerX() - (float) adj3H / 4, rect.top + (float) (arrowHeight - adj1) / 2 + adj1);
            path.lineTo(rect.left + adj2, rect.top + (float) (arrowHeight - adj1) / 2 + adj1);
